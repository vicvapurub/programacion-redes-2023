...
def agregar_producto():
    ...
    conn = conectar_db()
    cursor = conn.cursor()
    cursor.execute('INSERT INTO Productos (Nombre, Precio, Stock, Descripcion, Categoria, IndiceProducto) VALUES (?, ?, ?, ?, ?, ?)',
                   (nuevo_producto['Nombre'], nuevo_producto['Precio'], nuevo_producto['Stock'], nuevo_producto['Descripcion'],
                    nuevo_producto['Categoria'], nuevo_producto['IndiceProducto']))
    conn.commit()
