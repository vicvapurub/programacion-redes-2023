...
* Fecha: 20/11/2022
* API: URL Shortener
* Función: Si tines una URL larga y la quieres recorta genera una URL corta que será redirigida a la original
'''
...
def main():
    ...
    while True:
        url_para_recortar = input("Ingrese la URL que desea recortar y puede agregar un alias para identificar la URL(si desea salir escriba \"fin\"): ")
